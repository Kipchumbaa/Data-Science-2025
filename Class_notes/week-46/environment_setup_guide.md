...
### 4. Setup RAPIDS Environment on EC2
```bash
# Create environment
...
### 5. Configure AWS on EC2
```bash
# Configure with your credentials
aws configure
# Use the credentials provided by instructor
```

### 6. Setup Project Structure on EC2
```bash
