...
- **EC2 Instance**: `i-0a444afe43fd747c7` (t3.medium, 54.197.52.129) - Primary compute environment
...
- **EC2 Instance Types**: t3.medium (current) for development, g4dn.xlarge (recommended) for GPU acceleration
...
#### Core Infrastructure
- **EC2 Instance (i-0a444afe43fd747c7)**: Primary compute environment at 54.197.52.129
  - Instance Type: t3.medium (CPU), upgradeable to g4dn.xlarge (GPU)
